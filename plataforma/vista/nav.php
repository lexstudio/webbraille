...
<nav class="main-nav"><!--barra de navegacion-->
        <div class="container container--flex">
            ...
            <ul class="menu" id="menu">
                ...
                <li class="menu__item"><a id="enlacenav3" href='#' class="menu__link">Aprendizaje</a></li>
                <li class="menu__item"><a id="enlacenav4" href='../contactanos/contactos.php' class="menu__link">Contactanos</a></li>
            </ul>
