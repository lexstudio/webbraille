...
/* 
        ...
        $consulta="SELECT Foto FROM users WHERE Id=3";
                ...
                <div class="container container--flex">
                        ...
                        <form action="actualizar_datos.php" method="post" class="formulario column column--50" name=form_user enctype="multipart/form-data">
                            ...
                            <div class='zona_imagen'>
                                <img src="/Partes/user_image/<?= $user['Foto']?>" alt="Imagen perfil">  
                            </div>
                        ...
                        <div class="contact-information column column--50">
                            ...
                            <div class='zona_imagen'>
                                <img src="/Partes/user_image/<?= $user['Foto']?>" alt="Imagen perfil" width="50%">
                            </div>
